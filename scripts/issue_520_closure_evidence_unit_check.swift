...
assertTrue(contentView.contains("WatchControlSurfaceView"), "watch content should render the unified control surface")
assertTrue(controlSurfaceView.contains("WatchPrimaryActionDockView"), "control surface should render the action dock")
assertTrue(!controlSurfaceView.contains("WatchActionBannerView"), "control surface should not render the banner any more")
assertTrue(contentView.contains("WatchActionBannerView"), "information surface should render the banner")
