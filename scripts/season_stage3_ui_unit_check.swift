...
assertTrue(homeView.contains("seasonDetailSheet"), "HomeView should provide season detail sheet")
assertTrue(homeView.contains("todayScoreDelta"), "HomeView should show today's season score delta")
assertTrue(homeView.contains("seasonRewardStatusText"), "HomeView should render reward claim status text")
