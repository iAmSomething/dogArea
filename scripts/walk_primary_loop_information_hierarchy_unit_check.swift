...
assertTrue(homeCard.contains("home.walkPrimaryLoop.openGuide"), "home walk primary loop card should expose a guide entry affordance")
assertTrue(homeCard.contains("home.walkPrimaryLoop.guide.sheet"), "home walk primary loop guide sheet should exist")
assertTrue(homeCard.contains("home.walkPrimaryLoop.guide.pillar."), "home walk primary loop detail pillars should move into the guide sheet")
...
assertTrue(featureTests.contains("testFeatureRegression_HomeWalkPrimaryLoopCardStaysCompactAndOpensGuideOnDemand"), "feature regression tests should cover compact home walk primary loop disclosure")
...
assertTrue(featureScript.contains("testFeatureRegression_HomeWalkPrimaryLoopCardStaysCompactAndOpensGuideOnDemand"), "feature regression script should run the compact home walk primary loop disclosure regression")
assertTrue(uiMatrix.contains("FR-HOME-002"), "ui regression matrix should include the home/map primary loop regression")
assertTrue(uiMatrix.contains("FR-HOME-002A"), "ui regression matrix should include the compact home walk primary loop regression")
assertTrue(doc.contains("compact summary 카드"), "issue doc should record the compact home summary hierarchy")
assertTrue(doc.contains("설명 보기"), "issue doc should record explicit disclosure entry")
