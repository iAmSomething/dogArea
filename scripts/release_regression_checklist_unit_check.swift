...
assertTrue(checklist.contains("운영 비교 구역"), "checklist should include remote area reference scenario")
assertTrue(checklist.contains("기본 비교 구역"), "checklist should include area fallback scenario")
