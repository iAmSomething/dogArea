...
assertTrue(helper.contains("resolveAnonOnboardingProfileImageObjectPath"), "shared storage helper should expose anon onboarding profile image path resolver")
...
assertTrue(uploadProfileImage.contains("resolveAnonOnboardingProfileImageObjectPath"), "upload-profile-image should use shared anon onboarding path resolver")
