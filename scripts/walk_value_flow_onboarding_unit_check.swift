...
assertTrue(guideSheet.contains("map.walk.guide.step.understanding"), "walk value guide sheet should expose the step1 identifier")
assertTrue(guideSheet.contains("map.walk.guide.step.preferences"), "walk value guide sheet should expose the step2 identifier")
assertTrue(guideSheet.contains("map.walk.guide.card.\\(card.id)"), "walk value guide sheet should render dynamic understanding card identifiers")
assertTrue(guideSheet.contains("map.walk.guide.next"), "walk value guide sheet should expose the step transition CTA")
assertTrue(guideSheet.contains("map.walk.guide.recordMode.\\(option.id)"), "walk value guide sheet should expose dynamic record mode identifiers")
assertTrue(guideSheet.contains("map.walk.guide.sharingDefault"), "walk value guide sheet should expose the sharing default card")
assertTrue(guideService.contains("protocol WalkValueGuidePresentationProviding"), "walk value guide should be protocol-first")
assertTrue(guideService.contains("settingsReentry"), "walk value guide service should support settings reentry context")
assertTrue(guideService.contains("id: \"record\""), "walk value guide service should define the record understanding card")
assertTrue(guideService.contains("id: \"territory\""), "walk value guide service should define the territory understanding card")
assertTrue(guideService.contains("id: \"season\""), "walk value guide service should define the season understanding card")
assertTrue(guideService.contains("id: \"mission\""), "walk value guide service should define the mission understanding card")
assertTrue(guideService.contains("id: \"manual\""), "walk value guide service should define the manual record mode option")
assertTrue(guideService.contains("id: \"auto\""), "walk value guide service should define the automatic record mode option")
...
assertTrue(settingsView.contains("settings.walkGuide.reopen"), "settings should expose the walk guide reentry CTA")
...
assertTrue(featureTests.contains("testFeatureRegression_SettingsWalkGuideReentryPresentsTwoStepGuide"), "feature regression tests should cover settings walk guide reentry")
...
assertTrue(featureScript.contains("testFeatureRegression_SettingsWalkGuideReentryPresentsTwoStepGuide"), "feature regression script should include settings walk guide reentry regression")
