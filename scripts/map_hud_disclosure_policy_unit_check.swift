...
assertTrue(activeService.contains("disclosureMode: .expandInline"), "walking HUD should keep inline disclosure as the primary path")
...
assertTrue(mapView.contains("walkingHUDDetailPresentation"), "MapView should keep a dedicated walking HUD detail presentation path")
