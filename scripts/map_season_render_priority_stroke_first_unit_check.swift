...
assertTrue(mapSubView.contains("// 5. 현재 산책 route는 season stroke보다 위에 둬 주 레이어를 명확히 합니다."), "MapSubView should document route-above-stroke priority")
assertTrue(mapSubView.contains("Color.clear"), "season tile hit target should no longer leave a visible dot")
