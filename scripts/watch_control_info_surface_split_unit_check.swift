...
assertTrue(controlSurfaceView.contains("WatchActionBannerView"), "control surface should own the feedback banner hierarchy")
assertTrue(controlSurfaceView.contains(".inline"), "control surface should render feedback as inline state instead of a separate card layer")
