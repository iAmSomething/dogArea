...
assertTrue(mapSubView.contains("MapRenderBudgetProbeOverlay"), "MapSubView should expose a render budget probe overlay for diagnostics.")
...
assertTrue(startButton.contains("MapWalkingElapsedTimeValueText"), "StartButtonView should localize elapsed time updates to a dedicated timeline view.")
