...
assertTrue(primaryLoopView.contains("lineLimit(2)"), "primary loop secondary copy should wrap within two lines")
...
assertTrue(contextView.contains("lineLimit(2)"), "context helper should wrap within two lines")
...
assertTrue(doc.contains("helper 문구는 필요한 경우 2줄까지 허용"), "doc should describe wrapped helper contract")
