...
assertTrue(!controlSurfaceView.contains("WatchActionBannerView"), "control surface should not keep the feedback banner after rehardening")
assertTrue(contentView.contains("WatchActionBannerView"), "information surface should keep the feedback banner route")
...
assertTrue(closureDoc.contains("feedback banner"), "issue #698 closure evidence should record the secondary information move")
