...
let mapSummarySheet = load("dogArea/Views/MapView/MapSubViews/MapSeasonTileSummarySheetView.swift")
...
assertTrue(mapSummaryCard.contains("map.season.summary.openOverview"), "Map season summary card should expose an overview entry button")
assertTrue(mapSummarySheet.contains("map.season.sheet.openGuide"), "Map season summary sheet should expose a season guide entry button")
...
assertTrue(mapView.contains("MapSeasonTileSummarySheetView"), "MapView should present the season overview sheet")
