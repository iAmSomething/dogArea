...
assertTrue(mapSubView.contains("clusterMotionToken"), "MapSubView should react to cluster motion token")
...
assertTrue(mapViewModel.contains("clusterMotionTransition"), "MapViewModel should manage cluster transition state")
