...
assertTrue(runbook.contains("Email Confirmation Policy"), "runbook should require confirmation policy evidence")
assertTrue(runbook.contains("Password Reset Policy"), "runbook should require password reset policy evidence")
assertTrue(runbook.contains("Email Change Policy"), "runbook should require email change policy evidence")
assertTrue(runbook.contains("Invite Policy"), "runbook should require invite policy evidence")
...
assertTrue(template.contains("Email Confirmation Policy"), "template should include confirmation policy field")
assertTrue(template.contains("Password Reset Policy"), "template should include password reset policy field")
assertTrue(template.contains("Email Change Policy"), "template should include email change policy field")
assertTrue(template.contains("Invite Policy"), "template should include invite policy field")
