...
assertTrue(headerView.contains("walklist.header"), "Header view should expose top-level header accessibility identifier")
...
assertTrue(walkListCell.contains("영역 넓이"), "WalkListCell should surface area metrics")
assertTrue(walkListCell.contains("포인트 수"), "WalkListCell should surface point count metrics")
assertTrue(headerView.contains("walklist.summary"), "Header view should expose summary card identifier")
assertTrue(headerView.contains("walklist.context"), "Header view should expose context card identifier")
