...
- 구현: #23, #30, #31
- 구현(1차 저장소 추상화): #117
- 백필 계약: `docs/coredata-supabase-backfill.md`
...
2026-02-26 반영 (#117):
- `ProfileRepository` + `DefaultProfileRepository` 도입
- `SigningViewModel`, `SettingViewModel`의 직접 `UserdefaultSetting/ProfileSyncCoordinator` 의존 제거
- profile sync enqueue/flush 책임을 repository로 이동
