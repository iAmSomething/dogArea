...
struct RootView: View {
  ...
  @State private var walkListView = WalkListView()
  @State private var mapView = MapView()
  @State private var textToImageView = TextToImageView()
  @State private var notificationCenterView = NotificationCenterView()
