    ...
    func makeOverview(
        ...
        if isShowingAllRecordsOverride {
            return WalkListOverviewModel(
                ...
                primaryLoopMessage: "저장한 산책은 경로, 영역, 시간 기록으로 남고 홈 목표와 시즌 흐름을 다시 읽는 기준이 됩니다.",
        ...
        if selectedPetId.isEmpty == false {
            return WalkListOverviewModel(
                ...
                primaryLoopBadge: "기본 행동",
                primaryLoopTitle: "산책이 기록의 시작점이에요",
                primaryLoopMessage: "한 번의 산책이 경로, 영역, 시간 기록으로 쌓이고 이후 목표와 미션, 시즌 해석의 기준이 됩니다.",
        ...
        return WalkListOverviewModel(
            ...
            primaryLoopBadge: "기본 행동",
            primaryLoopTitle: "산책이 기록의 시작점이에요",
            primaryLoopMessage: "한 번 저장한 산책은 경로, 영역, 시간 기록이 되고 다시 보는 기준이 됩니다.",
            primaryLoopSecondaryFlowText: "실내 미션은 산책이 어려운 날의 보조 흐름입니다.",
            modeBadge: "전체 반려견 기준",
