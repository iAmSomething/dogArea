    ...
    func makeOverview(
        ...
        if isShowingAllRecordsOverride {
            return WalkListOverviewModel(
                title: "산책 기록",
                subtitle: "기록 범위를 빠르게 바꾸고 최근 산책을 다시 읽는 화면이에요.",
                primaryLoopBadge: "기본 행동",
                primaryLoopTitle: "산책이 기록을 만듭니다",
                primaryLoopMessage: "저장한 산책이 경로, 영역, 시간, 포인트 기록으로 남습니다.",
                primaryLoopSecondaryFlowText: "실내 미션은 보조 흐름입니다.",
                modeBadge: "전체 기록 보기",
                contextTitle: "지금은 전체 기록을 함께 보고 있어요",
                contextMessage: "\(selectedPetName) 기준 기록이 없어 전체 보기로 넓혔습니다. 필요하면 바로 선택 기준으로 돌아갈 수 있어요.",
                helperMessage: "반려견 칩을 바꾸면 같은 화면에서 바로 비교됩니다.",
        ...
        if selectedPetId.isEmpty == false {
            return WalkListOverviewModel(
                title: "산책 기록",
                subtitle: "날짜와 반려견 기준으로 산책 기록을 다시 읽는 화면이에요.",
                primaryLoopBadge: "기본 행동",
                primaryLoopTitle: "산책이 기록을 만듭니다",
                primaryLoopMessage: "한 번의 산책이 경로, 영역, 시간, 포인트 기록으로 쌓입니다.",
                primaryLoopSecondaryFlowText: "실내 미션은 예외 상황의 보조 흐름입니다.",
                modeBadge: "선택 반려견 기준",
                contextTitle: "\(selectedPetName) 기준으로 보고 있어요",
                contextMessage: "반려견을 바꾸면 목록, 요약, 달력이 같은 기준으로 함께 바뀝니다.",
                helperMessage: "기록이 없으면 전체 기록 보기로 바로 넓힐 수 있어요.",
        ...
        return WalkListOverviewModel(
            ...
            contextMessage: "반려견을 고르면 목록과 달력이 같은 기준으로 바로 좁혀집니다.",
            helperMessage: "필요하면 전체 기록 보기로 다시 넓혀 비교할 수 있어요.",
            restoreActionTitle: nil,
            metrics: [
