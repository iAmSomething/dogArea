...
final class SettingViewModel: ObservableObject {
    ...
    private var uiTestPetManagementUserInfoOverride: UserInfo? = nil
    ...
    private var isUITestPetManagementStubEnabled: Bool {
    ...
    func reloadUserInfo() {
        self.userInfo = resolveDisplayedUserInfo()
    ...
    private func resolveDisplayedUserInfo() -> UserInfo? {
        let fetchedUserInfo = profileRepository.fetchUserInfo()
        guard isUITestPetManagementStubEnabled else {
    ...
    private func makeUITestPetManagementUserInfo(base: UserInfo?) -> UserInfo {
    ...
    private func makeUITestPetManagementPet(
        petId: String,
        petName: String,
        breed: String,
        ageYears: Int,
    ...
    ///   - gender: 반려견 성별 입력값입니다.
    /// - Returns: 입력 검증 및 상태 반영 결과입니다.
    private func updateUITestPetStub(
        petId: String,
        petName: String,
        breed: String,
        ageYearsText: String,
    ...
    private func updatePet(
        ...
        do {
            ...
            switch error {
            case .cannotDeactivateLastActivePet:
                return .failure(ProfileEditValidationError.cannotDeactivateLastActivePet)
            case .imageEncodingFailed:
                return .failure(ProfileEditValidationError.imageEncodingFailed)
            case .petNotFound:
                return .failure(ProfileEditValidationError.selectedPetNotFound)
    ...
    private func validateRequiredName(
        _ rawValue: String,
    ...
    private func parseAgeYears(from value: String) throws -> Int? {
